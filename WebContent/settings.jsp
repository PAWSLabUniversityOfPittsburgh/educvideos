		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body" id="modal-body">
					<form id="domainForm" class="form-horizontal" role="form">
						<input id="domain_id" type="hidden">
						<div class="form-group">
							<label for="domain_name" class="control-label col-md-2">Name:</label>
							<div class="col-md-10">
								<input id="domain_name" type="text" name="domain_name" placeholder="Name of Domain" required="required" class="form-control" readonly="">
							</div>
						</div>
						<div class="form-group">
							<label for="domain_title" class="control-label col-md-2">Title:</label>
							<div class="col-md-10">
								<input id="domain_title" type="text" name="domain_title" placeholder="Title of Domain" required="required" class="form-control" readonly="">
							</div>
						</div>
						<div class="form-group">
							<label for="domain_description" class="control-label col-md-2">Description:</label>
							<div class="col-md-10">
								<textarea rows="3" id="domain_description" name="domain_description" placeholder="Description of Domain" required="required" class="form-control" readonly=""></textarea>
							</div>
						</div>
						<div class="form-group">
							<label for="domain_author" class="control-label col-md-2">Author:</label>
							<div class="col-md-10">
								<input id="domain_author" type="text" name="domain_author" value="
							<%
							try {
									String user = (String) session.getAttribute("user");
									out.println(user);
						...
						<div class="form-group">
							<label for="domain_license" class="control-label col-md-2">License:</label>
							<div class="col-md-10">
								<input id="domain_license" type="text" name="domain_license" placeholder="License of Domain" required="required" class="form-control" readonly="">
							</div>
						</div>
						<div class="form-group">
							<label for="domain_version" class="control-label col-md-2">Version:</label>
							<div class="col-md-10">
								<input id="domain_version" type="text" name="domain_version" placeholder="Version of Domain" required="required" class="form-control" readonly="">
							</div>
						</div>
						<div class="form-group">
							<label for="domain_created" class="control-label col-md-2">Created on:</label>
							<div class="col-md-10">
								<input id="domain_created" type="text" name="domain_created" readonly required="required" class="form-control" readonly="">
							</div>
						</div>
						<div class="form-group">
							<label for="domain_modified" class="control-label col-md-2">Last modified on:</label>
							<div class="col-md-10">
								<input id="domain_modified" type="text" name="domain_modified" readonly required="required" class="form-control" readonly="">
							</div>
						</div>
						<div class="form-group">
							<label for="domain_keywords" class="control-label col-md-2">Keywords:</label>
							<div class="col-md-10">
								<input id="domain_newkeyword" type="text" name="domain_newkeyword" placeholder="Press enter to add new keyword" class="form-control" onchange="addKeyword(this)" />
							</div>
							<ul id="domain_keywords">
							</ul>
						</div>
					</form>
				</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body" id="modal-body">
					...
					<div class="form-group">
						<label for="topic_description">Description:</label><textarea rows="3" id="topic_description" type="text" name="topic_description" placeholder="Description of Topic" required="required" class="form-control" readonly=""></textarea>
					</div>
					<div class="form-group">
							<label for="topic_keywords">Keywords:</label>
							<input id="topic_newkeyword" type="text" name="topic_newkeyword" placeholder="Press enter to add new keyword" class="form-control" onchange="addTopicKeyword(this)" />
							<ul id="topic_keywords">
							</ul>
						</div>
				</div>
				<div class="modal-footer" id="modal-footer">
