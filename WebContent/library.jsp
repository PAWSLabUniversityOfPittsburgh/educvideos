		...
		<%
			...
			if(domainModels!=null) {
				...
				for(TopicModel topicModel: domainModel.getTopics()) {
					...
					out.println("<a data-toggle=\"collapse\" href=\"#collapse"+topicModel.getId()+"\"><span id=\"topic"+topicModel.getId()+"\" class=\"glyphicon glyphicon-collapse-down\"></span> "+topicModel.getTitle()+"</a>");
					out.println("</h4></div>");
					out.println("<div id=\"collapse"+topicModel.getId()+"\" class=\"panel-collapse collapse in\">");
					out.println("<ul class=\"list-group\">");
					if(topicModel.getSegments()!=null) {
						for(SegmentModel segmentModel: topicModel.getSegments()) {
							out.println("<li class=\"list-group-item\">");
							out.println("<div class=\"row\">");
							out.println("<div class=\"col-md-3\"><button type=\"button\" class=\"btn btn-link\" onclick=\"viewSegment("+segmentModel.getId()+")\" data-toggle=\"modal\" data-target=\"#segmentModal\"><img src=\"http://img.youtube.com/vi/"+segmentModel.getYoutubeId()+"/default.jpg\" class=\"img-thumbnail\" width=\"152\" height=\"118\" /></button></div>");
							out.println("<div class=\"col-md-6\">");
							out.println("<ul class=\"list-unstyled\">");
							out.println("<li><button type=\"button\" class=\"btn btn-link\" onclick=\"viewSegment("+segmentModel.getId()+")\" data-toggle=\"modal\" data-target=\"#segmentModal\"><h4>"+segmentModel.getTitle()+"</h4></button></li>");
					...
					out.println("</ul>");
					out.println("</div></div>");
					//adding script to enable panel collapse for each topic
					out.println("<script>$('#collapse"+topicModel.getId()+"').on('show.bs.collapse', function(){"
							+"$('#topic"+topicModel.getId()+"').removeClass('glyphicon-collapse-up').addClass('glyphicon-collapse-down');"
						+"});"  
						+"$('#collapse"+topicModel.getId()+"').on('hide.bs.collapse', function(){"
							+"$('#topic"+topicModel.getId()+"').removeClass('glyphicon-collapse-down').addClass('glyphicon-collapse-up');"
						+"});</script>");
				}
			}
		%>
